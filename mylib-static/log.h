...
#define MYLIB_LOG_BASE(level, logger)                                       \
  ...
  MYLIB_SPACE_NAME::LogWarp{MYLIB_SPACE_NAME::LogEvent::LE_##level, logger, __##FILE__, __##func__, CLASS_NAME_, __##LINE__}.msg()
...
public:
  ...
  explicit LogEvent(String loggerName = "", String file = "", String funcName = "", String className = "", String coroutineName = "", String threadName = "UNKNOWN", value_type type = LE_UNDEFINED, uint32 line = 0, time_t t = 0, tid_t thread = 0, cid_t coroutine = 0);
  ...
  inline value_type getType() const { return m_type; }
  inline void setType(value_type mType) { m_type = mType; }
...
public:
  ...
  using Lock = LogUselock;
  inline explicit LogAppender(LogEvent::value_type type = DEF_LEVEL,
...
class LogWarp {
public:
  LogWarp(LogEvent::value_type level, Logger::ptr logger, String file, String funcName, String className, int32 line);
